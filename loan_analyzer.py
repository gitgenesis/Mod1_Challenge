...
print(f"The total number of loans from the list is: {total_number_of_loans}")
...
follow these steps to calculate a Present Value, 
...
print(f'The future Value is: ${future_value} \n(Future Value represents the amount of money the borrower has to pay back upon maturity of the loan (a.k.a. "Face Value")) ')
print(f"The Remaining Months on the loan is: {remaining_months} \n(This represents the maturity (in months) before the loan needs to be fully repaid.)")
...
# knowing that the discount rate is 20%
discount_rate = 0.20
...
""" On my first Attempt 
# Did All_loans_list as the list of all loans contained in the Main list above 
all_loans_list = [[loans[0]["loan_price"], loans[1]["loan_price"], loans[2]["loan_price"], loans[3]["loan_price"]]
...
# YOUR CODE HERE!
print("This is the list of inexpensive loans: ", inexpensive_loans)
...
""" Use this code to check current directory path
my_dir = Path(".")
print(my_dir)
""" 
